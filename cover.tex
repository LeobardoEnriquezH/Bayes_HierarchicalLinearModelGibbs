\begin{titlepage}
	...
	\HRule \\[0.4cm]
	{ \Large \bfseries Presentación}\\[0.4cm] % Title of your document
	\textsc{\Large Modelo Jerárquico Normal Lineal. Un enfoque Bayesiano usando Gibbs Sampler}\\[1cm] % Major heading such as course name
	\HRule \\[1.2cm]
